...
For **arm** deployments set `image.repository` to `--set image.repository=quay-mirror.qiniu.com/external_storage/nfs-client-provisioner-arm`
...
| `image.repository`                | Provisioner image                           | `quay-mirror.qiniu.com/external_storage/nfs-client-provisioner`         |
